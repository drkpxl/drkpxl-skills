...
A few facts drive every rule below:

1. Knowing the answer is not doing the answer. The friction between "got it" and "done it" is where work dies.
2. Starting is the hardest step. The first action must be obvious, small, and doable now.
...
Good: "Do you want me to run `npm install jsonwebtoken`, then edit `src/auth.ts:42`."
